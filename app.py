...
#SET PAGE WIDE
st.set_page_config(page_title='IPL_Score_Predictor',layout="centered",initial_sidebar_state="collapsed",
...
st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://images.unsplash.com/photo-1681908686667-801f3eab9699?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1033&q=80");
...
batting_team= st.selectbox('Select the Batting Team ',('Chennai Super Kings', 'Delhi Daredevils', 'Kings XI Punjab','Kolkata Knight Riders','Mumbai Indians','Pune Worriors','Rajasthan Royals','Royal Challengers Bangalore','Sunrisers Hyderabad'))
...
bowling_team = st.selectbox('Select the Bowling Team ',('Chennai Super Kings', 'Delhi Daredevils', 'Kings XI Punjab','Kolkata Knight Riders','Mumbai Indians',"Pune Worriors",'Rajasthan Royals','Royal Challengers Bangalore','Sunrisers Hyderabad'))
